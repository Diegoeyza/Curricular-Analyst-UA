function filterAndCopyByType() {
    ...
    var uniqueIdRange = rawDataSheet.getRange(2, 3, lastRow, 1); // Column C, including row 1
    var areaTypeRange = rawDataSheet.getRange(2, 33, lastRow, 1); // Column AG, including row 1
